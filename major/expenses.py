    ...
    with tab_manage:
        ...
        if df.empty:
            ...
            if selected_target_label:
                ...
                # Initialize state variables to prevent form dialogue intersection bugs
                ...
                with st.form(f"edit_form_container_{target_id}"):
                    ...
                    if action_save:
                        ...
                        if adjusted_amount > 0 and adjusted_desc.strip():
                            ...
                            # Uses case-normalized keys from df to maintain historical metadata fields safely
                ...
                # ==================================
                # DELETE CONFIRMATION POPUP (OUTSIDE FORM SCOPE)
                # ==================================
