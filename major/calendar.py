...
def show_calendar():
    ...
    st.markdown(
        "<h4 style='color: #2B3F87;'>📊 Revenue Forecast (This Month)</h4>",
        unsafe_allow_html=True
    )
    ...
    # -----------------------------
    st.markdown(
        "<h4 style='color: #2B3F87;'>📌 Action Items for Today</h4>",
        unsafe_allow_html=True
    )
    ...
    try:
        ...
        if not overdue_df.empty:
            ...
            st.info(
                "No overdue loans currently. Everything is on track! ✨"
            )
