...
def show_borrowers():
    ...
    # 📥 LOAD & NORMALIZE DATA
    # ==============================
    # ✅ PASSING TENANT_ID TO RESOLVE "missing 1 required positional argument: 'tenant_id'" BUGS
    borrowers_df = safe_df(get_cached_data("borrowers", tenant_id))
    loans_df = safe_df(get_cached_data("loans", tenant_id))
