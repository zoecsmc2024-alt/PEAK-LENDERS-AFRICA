...
def show_expenses():
    ...
    EXPENSE_CATS = ["Rent","Insurance","Utilities","Salaries","Marketing","Office Expenses","Operating Expenses","Fuel and Motor Vehicle","Taxes","Corporate Social Responsibilities","Other"]
